#!/bin/bash
#SBATCH --job-name=infer_cn_enh
#SBATCH --partition=gigabyte_a6000
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=8
#SBATCH --time=02:00:00
#SBATCH --output=logs/infer_cn_enhanced_captions_%j.log
...
python training/infer_z_image_controlnet_glyph.py \
    ...
    --training_dir /scratch2/shaush/training_output/controlnet_glyph_enhanced_captions \
    --output_dir /scratch2/shaush/training_output/controlnet_glyph_enhanced_captions/infer_results \
    --prompt \
