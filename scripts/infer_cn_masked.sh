#!/bin/bash
#SBATCH --job-name=infer_cn_masked
#SBATCH --partition=gigabyte_a6000
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=8
#SBATCH --time=02:00:00
#SBATCH --output=logs/infer_cn_masked_%j.log
...
python training/infer_z_image_controlnet_glyph.py \
    ...
    --training_dir /scratch2/shaush/training_output/controlnet_glyph_masked \
    --output_dir /scratch2/shaush/training_output/controlnet_glyph_masked/infer_results \
    --prompt \
