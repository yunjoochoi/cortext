#!/bin/bash
#SBATCH --job-name=infer_contra
#SBATCH --partition=gigabyte_a6000
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=8
#SBATCH --time=01:00:00
#SBATCH --output=logs/infer_contrastive_%j.log
...
python training/infer_lora_z_image_simple.py \
    ...
    --training_dir /scratch2/shaush/training_output/lora_contrastive \
    --output_dir /scratch2/shaush/training_output/lora_contrastive/infer_results \
    --prompt \
