...
accelerate launch --num_processes 2 training/train_lora_z_image_simple_attend_contrastive.py \
    ...
    --output_dir /scratch2/shaush/training_output/lora_contrastive \
    --max_pixels 1048576 \
    --train_batch_size 1 \
