...
class ManifestDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        bboxes = {ann["text"]: ann["bbox"] for ann in rec["annotations"]}
        return {
...
def compute_char_loss(
    ...
    for layer_idx in layer_indices:
        ...
        for b in range(bsz):
            ...
            # (n_heads, img_seq, head_dim) @ (n_heads, head_dim, txt_seq) → (n_heads, img_seq, txt_seq)
            q_h = q_img.permute(1, 0, 2)
            k_h = k_txt.permute(1, 2, 0)
